...
public class FieldsStartEntity {
    ...
    public FieldsStartEntity() {
    }

    public FieldsStartEntity(Long id, String name, BigDecimal costOfBuying, Long area, String info, Long areaOfPloughtFields, Long areaOfmeadow, Set<PlantsEntity> plants) {
        this.id = id;
        this.name = name;
        this.costOfBuying = costOfBuying;
        this.area = area;
